...
/**
 * @implements DependencyResolverInterface<ApplicationState>
 */
#[\Attribute(\Attribute::TARGET_PARAMETER)]
class AppState implements DependencyResolverInterface
{
    public function resolve(Container $container): mixed
    {
        return $container->resolve(Application::class)->appState;
    }
}
