...
class HasSessionFunction implements FunctionInterface
{
    public private(set) string $name = 'hasSession';
    ...
    public function call(
        ...
        return $this->container->resolve(SessionInterface::class)->has($name);
    }
}
