...
class CsrfFieldNameFunction implements FunctionInterface
{
    public private(set) string $name = 'csrf_field_name';
    ...
    public function call(
        ...
        return $this->container->resolve(CsrfManagerInterface::class)->fieldName;
    }
}
