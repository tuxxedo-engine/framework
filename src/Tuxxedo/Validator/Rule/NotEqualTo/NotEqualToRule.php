...
namespace Tuxxedo\Validator\Rule\NotEqualTo;
...
class NotEqualToRule implements RuleInterface
{
    public function __construct(
        public readonly int|float|string|bool|null $disallowed,
    ) {
    }
    ...
    public function check(
        ...
        if ($value !== $this->disallowed) {
            return null;
        }

        return new Violation(
            code: NotEqualToViolationCode::EQUAL,
            propertyPath: $context->currentPath,
            invalidValue: $value,
            context: new NotEqualToViolationContext(
