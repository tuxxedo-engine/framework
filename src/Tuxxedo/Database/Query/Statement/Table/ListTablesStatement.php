...
class ListTablesStatement implements ListTablesStatementInterface
{
    ...
    public function compile(
        ...
        return $resolvedConnection->dialect->listTables();
    }
    ...
    public function execute(
        ...
        $resolvedConnection = $this->resolveConnection($connection);
        $prepared = $resolvedConnection->dialect->listTables();
