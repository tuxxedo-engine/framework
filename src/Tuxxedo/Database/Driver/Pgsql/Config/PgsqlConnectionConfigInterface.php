...
#[DefaultImplementation(class: PgsqlConnectionConfig::class, lifecycle: Lifecycle::SINGLETON)]
interface PgsqlConnectionConfigInterface extends ConnectionConfigInterface
{
    public string $host {
        get;
    }
