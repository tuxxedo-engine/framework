...
use Tuxxedo\Validator\Rule\Instant\AfterInstantRule;
...
class AfterInstantRuleTest extends TestCase
{
    ...
    {
        $result = $this->runRule(
            rule: new AfterInstantRule(anchor: '2026-01-01T00:00:00Z'),
            value: null,
        );
    ...
    public function testInstantAfterAnchorPasses(): void
    {
        $result = $this->runRule(
            rule: new AfterInstantRule(anchor: '2026-01-01T00:00:00Z'),
    ...
    public function testInstantAtOrBeforeAnchorFails(): void
    {
        $result = $this->runRule(
            rule: new AfterInstantRule(anchor: '2026-06-01T00:00:00Z'),
            value: Instant::parse(input: '2026-06-01T00:00:00Z'),
        );

        self::assertNotNull($result);
        self::assertSame(InstantOrderViolationCode::NOT_AFTER, $result->code);
    }

    public function testAnchorInstantCarriedInContext(): void
    {
        $result = $this->runRule(
            rule: new AfterInstantRule(
