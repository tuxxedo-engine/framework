...
class ContinueBlockHandlerTest extends TestCase
{
    use TokenAssertionsTrait;

    private ContinueBlockHandler $handler;
    private ExpressionLexer $expressionLexer;
    private LexerState $state;

    protected function setUp(): void
    {
        $this->handler = new ContinueBlockHandler();
        $this->expressionLexer = new ExpressionLexer();
        $this->state = new LexerState();
    }

    public function testContinueHandlerDirectiveIsContinue(): void
    {
        self::assertSame(
            'continue',
    ...
    public function testStandaloneEmitsContinueTokenWithNullDepth(): void
    {
    ...
    public function testExpressiveWithEmptyExpressionEmitsContinueTokenWithNullDepth(): void
    {
        $tokens = $this->handler->lex(
            startingLine: 1,
            expression: '',
    ...
    public function testContinueHandlerLexPropagatesStartingLine(): void
    {
        $tokens = $this->handler->lex(
            startingLine: 42,
            expression: '2',
