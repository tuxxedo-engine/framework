...
use Tuxxedo\Model\Attribute\Connection\ModelDefaultReadConnection;
...
class ModelDefaultReadConnectionTest extends TestCase
{
    public function testResolveReturnsModelsManagerBoundToReadConnection(): void
    {
        ...
        $resolver = new ModelDefaultReadConnection();
