...
class ReflectionIsNullableResolver implements DependencyResolverInterface
{
    public function resolve(
        ...
        return new ReflectionResolverResult(
            new Parameter($parameter->reflector->getDeclaringFunction()->getParameters()[1])->isNullable(),
        );
    }
}
