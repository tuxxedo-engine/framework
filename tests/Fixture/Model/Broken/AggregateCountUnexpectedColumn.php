...
#[Table(name: 'aggregate_count_unexpected_column')]
class AggregateCountUnexpectedColumn
{
    ...
    #[RelationAggregate(relation: 'items', function: RelationAggregateFunction::COUNT, column: 'amount')]
